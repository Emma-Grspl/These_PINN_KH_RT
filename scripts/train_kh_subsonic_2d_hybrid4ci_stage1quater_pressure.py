...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--n-sym", type=int, default=KHSubsonic2DStage1quaterPressureConfig.n_sym)
    parser.add_argument("--sym-ymax", type=float, default=KHSubsonic2DStage1quaterPressureConfig.sym_ymax)
    ...
    parser.add_argument("--w-sym", type=float, default=KHSubsonic2DStage1quaterPressureConfig.w_sym)
    parser.add_argument("--w-center-deriv", type=float, default=KHSubsonic2DStage1quaterPressureConfig.w_center_deriv)
...
def main() -> int:
    ...
    cfg = KHSubsonic2DStage1quaterPressureConfig(
        ...
        w_sym=float(args.w_sym),
        w_center_deriv=float(args.w_center_deriv),
