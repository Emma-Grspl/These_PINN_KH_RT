...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--warmstart-run-dir",
        type=Path,
        default=Path("assets/pinn_subsonic/mach_fixed/frozen_M05_riccati_reference_current"),
    )
    parser.add_argument("--warmstart-checkpoint", type=Path, default=None)
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("model_saved/kh_subsonic_2d_pilot_M05_M06"),
    )
    parser.add_argument("--skip-training", action="store_true")
    parser.add_argument("--alpha-min", type=float, default=0.05)
    parser.add_argument("--alpha-max", type=float, default=0.75)
    parser.add_argument("--mach-min", type=float, default=0.50)
    parser.add_argument("--mach-max", type=float, default=0.60)
    ...
    parser.add_argument("--n-reference-mach", type=int, default=7)
    parser.add_argument("--n-audit-alpha", type=int, default=13)
    parser.add_argument("--n-audit-mach", type=int, default=5)
    ...
    parser.add_argument("--focus-mach-half-width", type=float, default=0.02)
    ...
    parser.add_argument("--upper-mach-min", type=float, default=0.58)
    parser.add_argument("--lower-alpha-max", type=float, default=0.20)
    parser.add_argument("--lower-mach-max", type=float, default=0.52)
    ...
    parser.add_argument("--ci-plot-mach", type=int, default=7)
    parser.add_argument("--ci-n-levels", type=int, default=8)
    parser.add_argument("--mode-audit-alpha", type=int, default=5)
    parser.add_argument("--mode-audit-mach", type=int, default=3)
    parser.add_argument("--mode-points", type=str, nargs="*", default=DEFAULT_MODE_POINTS)
...
def build_training_config(
    ...
    return KHSubsonic2DTrainingConfig(
        ...
        initial_model_kind="fixed_mach",
        initial_model_config_path=str(args.warmstart_run_dir / "config.csv"),
...
def main() -> None:
    ...
    cfg = build_training_config(args, warm_config, warm_checkpoint)
    pd.DataFrame(
        [
            {
                "pilot_name": "subsonic_2d_M05_M06_band",
