...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Supervision classique full-mode normalisee a high-alpha pour le PINN subsonique."
    )
    ...
    parser.add_argument("--balanced-full-mode-supervision-weight", type=float, default=10.0)
    parser.add_argument("--balanced-full-mode-supervision-n-xi", type=int, default=257)
    parser.add_argument("--balanced-full-mode-supervision-y-max", type=float, default=8.0)
    parser.add_argument("--balanced-full-mode-supervision-center-y-max", type=float, default=4.0)
    parser.add_argument("--balanced-full-mode-l2-weight", type=float, default=1.0)
    parser.add_argument("--balanced-full-mode-overlap-weight", type=float, default=2.0)
    parser.add_argument("--balanced-full-mode-rho-weight", type=float, default=1.0)
    parser.add_argument("--balanced-full-mode-u-weight", type=float, default=0.15)
...
def build_config(args: argparse.Namespace, initial_model_path: Path) -> KHSubsonicTrainingConfig:
    ...
    return KHSubsonicTrainingConfig(
        ...
        classic_balanced_full_mode_supervision_n_xi=int(args.balanced_full_mode_supervision_n_xi),
        classic_balanced_full_mode_supervision_xi_min=-0.98,
        classic_balanced_full_mode_supervision_xi_max=0.98,
        classic_balanced_full_mode_supervision_y_max=float(args.balanced_full_mode_supervision_y_max),
        classic_balanced_full_mode_supervision_center_y_max=float(args.balanced_full_mode_supervision_center_y_max),
        classic_balanced_full_mode_l2_weight=float(args.balanced_full_mode_l2_weight),
        classic_balanced_full_mode_overlap_weight=float(args.balanced_full_mode_overlap_weight),
        ...
        w_classic_balanced_full_mode_supervision=float(args.balanced_full_mode_supervision_weight),
...
def main() -> None:
    ...
    print(
        "Warm-start classic balanced full-mode supervision metrics "
    ...
    summary = {
        "regime": "high_alpha_classic_balanced_full_mode_supervision",
        "mach": float(args.mach),
        "alpha_min": float(args.alpha_min),
        "alpha_max": float(args.alpha_max),
        "alpha_target": float(args.alpha_target),
        ...
        "freeze_ci": True,
        "balanced_full_mode_supervision_weight": float(args.balanced_full_mode_supervision_weight),
        "balanced_full_mode_supervision_n_xi": int(args.balanced_full_mode_supervision_n_xi),
        "balanced_full_mode_supervision_y_max": float(args.balanced_full_mode_supervision_y_max),
        "balanced_full_mode_supervision_center_y_max": float(args.balanced_full_mode_supervision_center_y_max),
        "balanced_full_mode_l2_weight": float(args.balanced_full_mode_l2_weight),
        "balanced_full_mode_overlap_weight": float(args.balanced_full_mode_overlap_weight),
        "balanced_full_mode_rho_weight": float(args.balanced_full_mode_rho_weight),
        "balanced_full_mode_u_weight": float(args.balanced_full_mode_u_weight),
        "balanced_full_mode_v_weight": float(args.balanced_full_mode_v_weight),
        "balanced_full_mode_p_weight": float(args.balanced_full_mode_p_weight),
    ...
    summary_path = Path(args.output_dir) / "classic_balanced_full_mode_supervision_summary.csv"
    pd.DataFrame([summary]).to_csv(summary_path, index=False)

    print(
        f"regime=high_alpha_classic_balanced_full_mode_supervision alpha_target={float(args.alpha_target):.3f} "
