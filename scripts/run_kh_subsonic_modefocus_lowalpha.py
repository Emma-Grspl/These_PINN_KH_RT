...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run subsonic KH PINN with low-alpha mode-focused weighting and sparse ci supervision."
    )
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("model_saved/kh_subsonic_fixed_mach_M05_modefocus_lowalpha"))
...
def main() -> None:
    ...
    summary_path = args.output_dir / "modefocus_lowalpha_summary.csv"
